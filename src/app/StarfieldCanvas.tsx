      ...
      render() {
        ...
        switch (this.stage) {
          ...
          case 1: {
            ...
            const linkSpeedRel = linkSpeed * 0.00001 * canvasRef.current.width;
            ...
            if (this.traveled >= d) {
              ...
              const p = particles.current[this.linked[this.linked.length - 1]];
              const pos = position(p.x, p.y, p.z);
              points.push([pos.x, pos.y]);
              ...
              const a = particles.current[this.linked[this.linked.length - 1]];
